...
export default function CodeManagement() {
  const [codes, setCodes] = useState<CodeEntry[]>([
    { id: '1', code: 'TB-XJ92-K', user: 'salih@kod.com', expiresAt: new Date(Date.now() + 1000 * 60 * 60 * 23), status: 'Aktif' },
    { id: '2', code: 'TB-LL02-M', user: 'deneme@emlak.com', expiresAt: new Date(Date.now() - 1000 * 60 * 60), status: 'Süresi Doldu' },
    { id: '3', code: 'TB-AD01-A', user: 'admin@trust.com', expiresAt: new Date(Date.now() + 1000 * 60 * 60 * 5), status: 'Aktif' },
  ]);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black tracking-tight uppercase">Kod Yönetimi</h1>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-black tracking-tight uppercase group-hover:text-primary transition-colors">{code.code}</span>
                    <button className="text-white/20 hover:text-white transition-colors"><Copy className="w-3 h-3" /></button>
                  </div>
              ...
              <div className="flex items-center gap-12">
                <div className="text-right">
                  ...
                  <div className={`font-mono text-sm font-black ${
                    ...
                    {code.status === 'Aktif' ? '23 : 45 : 12' : '00 : 00 : 00'}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <button className="p-3 bg-rose-500/10 text-rose-500 rounded-xl opacity-0 group-hover:opacity-100 transition-all hover:bg-rose-500 hover:text-white shadow-xl shadow-rose-500/20">
